...
class FW102C(object):
    ...
    def query(self, cmdstr):
        ...
        ans = 'ERROR'
        self._sio.flush()
        res = self._sio.write(unicode(cmdstr+'\r'))
        if res:

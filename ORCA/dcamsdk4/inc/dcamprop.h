...
typedef enum _DCAMPROPATTRIBUTE
{
	...
	DCAMPROP_ATTR_ACTION		= 0x00000400,	/* writing value takes related effect		*/
...
/*	DCAMPROP_READOUT_UNIT__LINE					= 1,	*/		/*	"LINE"					*/	/* reserved */
	...
	DCAMPROP_TRIGGERENABLE_ACTIVE__BURST		= 6,			/*	"BURST"					*/

	/* DCAM_IDPROP_TRIGGERENABLE_SOURCE */
	DCAMPROP_TRIGGERENABLE_SOURCE__MULTI		= 7,			/*	"MULTI"					*/
	DCAMPROP_TRIGGERENABLE_SOURCE__SMA			= 8,			/*	"SMA"					*/
...
/*	DCAMPROP_CONTRAST_CONTROL__FRONTPANEL		= 3,	*/		/*	"FRONT PANEL"			*/	/* reserved */
	...
	DCAMPROP_DEVICEBUFFER_MODE__SNAPSHOTEX		= 6,			/*	"SNAPSHOTEX"			*/

	/* DCAM_IDPROP_INTERNALLINERATE_CONTROL */
	DCAMPROP_INTERNALLINERATE_CONTROL__SYNC_EXPOSURETIME		= 1,	/*	"SYNC EXPOSURETIME"			*/
	DCAMPROP_INTERNALLINERATE_CONTROL__PRIORITIZE_LINERATE		= 2,	/*	"PRIORITIZE LINERATE"		*/
	DCAMPROP_INTERNALLINERATE_CONTROL__PRIORITIZE_EXPOSURETIME	= 3,	/*	"PRIORITIZE EXPOSURETIME"	*/
...
/* Group: TIMING */
	...
	DCAM_IDPROP_TRIGGERENABLE_SOURCE			= 0x00100430,	/* R/W, mode,	"TRIGGER ENABLE SOURCE"	*/
	DCAM_IDPROP_TRIGGERENABLE_BURSTTIMES		= 0x00100440,	/* R/W, mode,	"TRIGGER ENABLE BURST TIMES"	*/
...
/* Group: ALU */
	...
	DCAM_IDPROP_SHADINGCALIB_TARGETMIN			= 0x00380680,	/* R/W, long,	"SHADING CALIB TARGET MIN" */
...
/* Group: READOUT */
	...
	DCAM_IDPROP_SENSORMODE_TDISTAGE				= 0x00400290,	/* R/W,	long,	"SENSOR MODE TDI STAGE"	*/
	...
	DCAM_IDPROP_BURIEDDATA_MODE					= 0x00400A00,	/* R/W, mode,	"BURIED DATA MODE"		*/
...
/* Group: TIMING */
	...
	DCAM_IDPROP_INTERNALLINERATE_CONTROL		= 0x00403870,	/* R/W, mode,	"INTERNAL LINE RATE CONTROL"	*/
...
/* Group: READOUT */
	...
	DCAM_IDPROP_IMAGEDETECTOR_PIXELWIDTH		= 0x00420810,	/* R/O, micro-meter, "IMAGE DETECTOR PIXEL WIDTH"	*/
	DCAM_IDPROP_IMAGEDETECTOR_PIXELHEIGHT		= 0x00420820,	/* R/O, micro-meter, "IMAGE DETECTOR PIXEL HEIGHT"	*/
	DCAM_IDPROP_IMAGEDETECTOR_PIXELNUMHORZ		= 0x00420830,	/* R/O, long,	"IMAGE DETECTOR PIXEL NUM HORZ" */
	DCAM_IDPROP_IMAGEDETECTOR_PIXELNUMVERT		= 0x00420840,	/* R/O, long,	"IMAGE DETECTOR PIXEL NUM VERT" */
...
/* Group: Camera Status */
	...
	DCAM_IDPROP_NUMBEROF_IMAGEBLOCK				= 0x004E0000,	/* R/O, long,	"NUMBER OF IMAGE BLOCK"	*/
	DCAM_IDPROP_IMAGEBLOCK_FIRSTBYTESOFFSET		= 0x004E1000,	/* R/O, long,	"IMAGEBLOCK FIRST BYTES OFFSET"*/
	DCAM_IDPROP_IMAGEBLOCK_ACTUALXPOS			= 0x004E2000,	/* R/O, long,	"IMAGEBLOCK ACTUAL XPOS"*/
	DCAM_IDPROP_IMAGEBLOCK_ACTUALYPOS			= 0x004E3000,	/* R/O, long,	"IMAGEBLOCK ACTUAL YPOS"*/
	DCAM_IDPROP_IMAGEBLOCK_ACTUALXSIZE			= 0x004E4000,	/* R/O, long,	"IMAGEBLOCK ACTUAL XSIZE"*/
	DCAM_IDPROP_IMAGEBLOCK_ACTUALYSIZE			= 0x004E5000,	/* R/O, long,	"IMAGEBLOCK ACTUAL YSIZE"*/
	DCAM_IDPROP_IMAGEBLOCK_OVERLAPLEFTSIZE		= 0x004E6000,	/* R/O, long,	"IMAGEBLOCK OVERLAP LEFT SIZE"*/
...
/* Group: SYSTEM */
	...
	DCAM_IDPROP_PRIMARYBUFFER_TOTALBYTES		= 0x00FF1030,	/* R/W, long,	"PRIMARY BUFFER TOTALBYTES"	*/
	DCAM_IDPROP_PRIMARYBUFFER_TOTALBYTES_MB		= 0x00FF1040,	/* R/W, long,	"PRIMARY BUFFER TOTALBYTES MB" */

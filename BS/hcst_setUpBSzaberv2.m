function hcst_setUpBSzaberv2(bench)
...
%     conn = Connection.openSerialPort('/dev/ttyFEUzaber');
    conn = Connection.openSerialPort('/dev/ttyBSzaber');
...
bench.BSzaber.conn = conn;
bench.BSzaber.axis = axis;

bench.BSzaber.CONNECTED = true;
% 
disp('*** Zaber stages for BSzaber initialized. ***');
% 

...
% hcst_andor_toggleFan(bench,'on'); %JLlop: Oct 10 waitng to plug cooling system/Feb 24 while the cooler pump is being repaired
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Turn on sensor cooler

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% hcst_andor_setSensorCooling(bench,true,wait2stabilize);
hcst_andor_setSensorCooling(bench,true,wait2stabilize);
% hcst_andor_setSensorCooling(bench,false,wait2stabilize);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

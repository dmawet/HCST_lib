...
BOOL PI_FUNC_DECL PI_qGFR(int ID, const int* piTableIdsArray,  int iNumberOfChannels,  int iOffsetOfFirstPointInTable,  int iNumberOfValues, double** pdValueArray, char* szGcsArrayHeader, int iGcsArrayHeaderMaxSize);

function devices = EnumerateUSBasArray(c, szFilter)
...
warning('"EnumerateUSBasArray()" is deprecated und may not be supported in future versions of PI MATLAB Driver. Use "EnumerateUSB()" instead.');

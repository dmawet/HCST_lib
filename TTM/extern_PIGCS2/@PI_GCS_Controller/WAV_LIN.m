function bRet = WAV_LIN(c,WaveTableId, OffsetOfFirstPointInWaveTable, iNumberOfWavePoints, AddAppendWave, iNumberOfSpeedUpDownPointsOfWave, AmplitudeOfWave, OffsetOfWave, SegmentLength)
% function bRet = WAV_LIN(c,WaveTableId, OffsetOfFirstPointInWaveTable, iNumberOfWavePoints, AddAppendWave, iNumberOfSpeedUpDownPointsOfWave, AmplitudeOfWave, OffsetOfWave, SegmentLength)
